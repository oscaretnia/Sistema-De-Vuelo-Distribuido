...
public class Executor {
    ...
    private String componerMenu() {
        ...
        builder.append("**** Sistema Argentina ****\n")
               ...
               .append("5.- Eliminar avion \n")
               .append("6.- Eliminar ruta \n")
               .append("7.- SALIR \n");    
    ...
    void insertarRuta(int id, String pais, String origen, String destino, String estado) {
        try {
            sistemaArgentina.insertarRuta(new Ruta(id, pais, origen, destino, estado));
        } catch (RemoteException ex) {
            Logger.getLogger(Executor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    void eliminarAvion(String matricula) {
        try {
            if (sistemaArgentina.eliminarAvion(matricula)) {
    ...
    void eliminarRuta(int id) {
        try {
            if (sistemaArgentina.eliminarRuta(id)) {
