...
public class Executor {
    ...
    void insertarAvion(String pais, String origen, String destino, String matricula, int cantidadPasajeros, String fechaVuelo) {
        try {
            sistemaChile.insertarAvion(new Avion(pais, origen, destino, matricula, cantidadPasajeros, fechaVuelo));
        } catch (RemoteException ex) {
            Logger.getLogger(Executor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    void insertarRuta(int id, String pais, String origen, String destino, String estado) {
        try {
            sistemaChile.insertarRuta(new Ruta(id, pais, origen, destino, estado));
        } catch (RemoteException ex) {
            Logger.getLogger(Executor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    void eliminarAvion(String matricula) {
        try {
            if (sistemaChile.eliminarAvion(matricula)) {
    ...
    void eliminarRuta(int id) {
        try {
            if (sistemaChile.eliminarRuta(id)) {
