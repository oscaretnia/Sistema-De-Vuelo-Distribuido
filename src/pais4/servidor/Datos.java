...
public class Datos {
    ...
    public Datos() {
       this.aeropuerto = new Aeropuerto("Pais 4");
       this.setDatos();
    }
    ...
    private void setAviones() {
        ...
        //crear aviones
        Avion avion1 = new Avion(this.aeropuerto.getPais(), "Pais 4", "Pais 3", "ydg5342", 100, "21-08-2020");
    ...
    private void setRutas() {
        ...
        Ruta ruta1 = new Ruta(this.aeropuerto.getPais(), "Pais 4", "Pais 3", "Activa");
        Ruta ruta2 = new Ruta(this.aeropuerto.getPais(), "Pais 1", "Pais 4", "Disponible");
